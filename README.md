# 微信支付 API v3 Go SDK
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/cedarwu/wechatpay-go)
[![huntr](https://cdn.huntr.dev/huntr_security_badge_mono.svg)](https://huntr.dev)
[![licence](https://badgen.net/github/license/wechatpay-apiv3/wechatpay-go)](https://github.com/cedarwu/wechatpay-go/blob/main/LICENSE)
...
```shell
go get -u github.com/cedarwu/wechatpay-go
```
...
import (
	...
	"github.com/cedarwu/wechatpay-go/services/certificates"
...
import (
	...
	"github.com/cedarwu/wechatpay-go/services/fileuploader"
)
...
import (
	...
	"github.com/cedarwu/wechatpay-go/core"
	"github.com/cedarwu/wechatpay-go/core/auth/credentials"
...
[#35](https://github.com/cedarwu/wechatpay-go/issues/35) 是一个很好的参考。
...
## 联系微信支付
如果你发现了 BUG，或者需要的功能还未支持，或者有任何疑问、建议，欢迎通过 [issue](https://github.com/cedarwu/wechatpay-go/issues) 反馈。
